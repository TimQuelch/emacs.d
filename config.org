...
#+begin_src emacs-lisp
  (use-package company-org-roam
    ...
    :config
    (my/set-mode-company-backends 'org-roam 'company-org-roam))
#+end_src
...
#+begin_src emacs-lisp
  (use-package company
    :hook ((after-init . global-company-mode)
           (after-change-major-mode . my/initialise-mode-company-backends))
    ...
    (defun my/get-mode-company-backends ()
      (let ((mode major-mode)
        ...
        (-distinct (-mapcat (lambda (mode) (cdr (assq mode my/company-backend-alist))) modes))))
