          ...
          '(("j" "Super agenda"
             ((agenda "" ((org-super-agenda-groups
                           '((:name "Schedule"
                             ...
                             (:todo "WAITING")
                             (:anything t :order 3)))))
              ;; TODO Unscheduled Next tasks
              ;; TODO Stuck projects Next projects
              (tags "REFILE"
...
#+begin_src emacs-lisp
  (defun my/is-project-p ()
    "Is a project. i.e. A task (with a todo keyword) that has a subtask (with a todo keyword)"
    (save-restriction
      (widen)
      (let ((has-subtask)
