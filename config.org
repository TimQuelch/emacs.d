...
#+begin_src emacs-lisp :tangle no
  (use-package company-org-roam
    ...
    :hook (org-mode . my/add-company-org-roam-backend-locally)
    :init (my/define-add-company-backend-locally-fun company-org-roam))
#+end_src
...
#+begin_src emacs-lisp
  (use-package company
    ...
    (defmacro my/define-add-company-backend-locally-fun (backend)
      (let ((fn-name (intern (format "my/add-%s-locally" backend))))
        `(defun ,fn-name ()
           ,(format "Add the company backend %s locally to company-backends." backend)
...
#+begin_src emacs-lisp :tangle no
  (use-package company-c-headers
    ...
    :demand
    :hook ((c-mode c++-mode) . my/add-company-c-headers-locally)
    :init (my/define-add-company-backend-locally-fun company-c-headers))
#+end_src
...
#+begin_src emacs-lisp :tangle no
  (use-package company-cmake              ; Included in company
    ...
    :hook (cmake-mode . my/add-company-cmake-backend)
    :init (my/define-add-company-backend-locally-fun company-cmake))
#+end_src
...
#+begin_src emacs-lisp :tangle no
  (use-package company-matlab-shell
    ...
    :demand
    :hook (matlab-shell-mode . my/add-company-matlab-shell-backend)
    :init (my/define-add-company-backend-locally-fun company-matlab-shell))
#+end_src
