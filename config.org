...
latex
markdown
(org +jupyter +noter +journal +present +hugo)
(python +pyenv)
(julia +lsp)
(sh +fish)
#+end_src
...
Update the pin for ~link-hint~ to use a version that has my PR merged that enables ~notmuch-hello~ link support.
#+begin_src emacs-lisp :tangle packages.el
...
(package! org-roam
  ...
  :pin "1b598a461849318fca2df3917c254d8ee483a87e")
(package! org-roam-bibtex
  :recipe (:host github :repo "org-roam/org-roam-bibtex")
  :pin "7c08a8928967a683666dbc1850e41537ab1fa01a")
