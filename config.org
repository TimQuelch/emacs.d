...
Don't use lsp-snippets. This is causing incorrect formatting on completion. I also don't really use it. See https://github.com/doomemacs/doomemacs/issues/6949 for details.
#+begin_src emacs-lisp
(after! lsp-mode
