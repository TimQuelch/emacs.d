...
(defun tq/phd-org-super-agenda-groups ()
  (cons '(:discard (:tag ("home" "hobby" "personal"))) org-super-agenda-groups))
#+end_src
...
#+begin_src emacs-lisp :tangle packages.el
(package! org-ref :pin "37b64e6cc1068c1b7ffe579851a345aa57772333")
#+end_src
#+begin_src emacs-lisp
(use-package! org-ref
  :after org
...
(package! org-roam
  ...
  :pin "67f10864df04e6a789dcca03e8cf7637b571098b")
...
#+begin_src emacs-lisp :tangle packages.el
(package! notmuch :pin "8e59438025c88ebd83a78cf12c06ff954d979e01")
#+end_src
#+begin_src emacs-lisp
(use-package! notmuch
  :defer t
...
(package! org-msg
  ...
  :pin "599e8b056c30e84d584aa54dd7c85339cdb9dc43")
#+end_src
#+begin_src emacs-lisp
(use-package! org-msg
  :after notmuch
...
Set notmuch user agent so org-msg knows where to put hooks
