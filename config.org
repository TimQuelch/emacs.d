...
#+begin_src emacs-lisp
(agenda "" ((org-super-agenda-groups tq/phd-org-super-agenda-groups)
            (org-agenda-span 'day)
            (org-agenda-start-day)))
#+end_src
...
Use ~org-msg~ to write HTML email in a sane way. My fork currently has a fix to ensure that notmuch FCC is handled correctly.
#+begin_src emacs-lisp :tangle packages.el
(package! org-msg
